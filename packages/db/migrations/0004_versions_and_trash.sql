...
-- Slug uniqueness now applies to live documents only.
DROP INDEX "documents_space_slug_idx";--> statement-breakpoint
CREATE UNIQUE INDEX "documents_space_slug_idx" ON "documents" USING btree ("space_id","slug") WHERE "deleted_at" is null;--> statement-breakpoint
...
CREATE UNIQUE INDEX "document_versions_doc_version_idx" ON "document_versions" USING btree ("document_id","version");
